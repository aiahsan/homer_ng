              ...
              <div class='col-xl-11 mx-auto'>
                <div class='row'>
                  <div class='col-lg-6 mt-3'>
                    <p class='p-lg bold'>
                      We will need you to create an account to store your
                      application details
                    </p>
                    <p class='p-lg bold'>Create Account</p>
                    <form action='#_'>
                      ...
                      <div class='mt-4'>
                        ...
                        <label for='terms'>
                          I agree to the{' '}
                          <span class='l-blue-text bold'>
                            {' '}
                            Terms of Service
                          </span>{' '}
                          and{' '}
                          <span class='l-blue-text bold'> Privacy Policy</span>
                        </label>
                      </div>
                      <button class='mt-4 site-btn w-100 py-3'>
                        Create Account and Continue Application
                      </button>
                      <p class='mt-4'>
                        Already registered?{' '}
                  ...
                  <div class='col-lg-6 mt-3'>
                    <p class='p-lg bold'>Or Sign Up with</p>
                    <div class='row'>
