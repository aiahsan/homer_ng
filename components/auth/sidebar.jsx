  ...
  return (
    <div className="l-blue-bg">
      <nav className="navbar px-4 d-flex d-lg-none navbar-expand-lg justify-content-between navbar-light navbar-lg bg-me1">
        ...
        <a className="navbar-brand bold">Welcome</a>
            ...
            <li className="nav-item">
              <div className="dropdown">
                <button
                  ...
                  aria-expanded="false"
                >
                  <img src="/images/avatar.png" alt="" className="img-fluid mr-2 avatar" /> Ahmed{" "}
                  <i className="fas ml-2 fa-caret-down"></i>
                </button>
                <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a className="dropdown-item" href="#">
                    Action
      ...
      <nav className="sidebar text-left" ss-container id="sidebar">
        <ul className="pl-0">
          <li className="w-100">
            <a href="#_" className="pr-0 m-0 active py-3 pl-3">
              <svg
                className="mr-3"
                width="26"
                height="26"
          ...
          <li className="w-100">
            <a href="#_" className="pr-0 m-0 py-3 pl-3">
              <svg
                className="mr-3"
                width="26"
                height="26"
      ...
      <nav className="sidebar pt-4" ss-container id="sidebar">
        <div className="text-center">
          <a href="index-login.php">
            <img src="/images/logo-login.png" alt="" className="my-5 mr-4 img-fluid" />
          </a>
        </div>
        <ul className="pl-0">
          <li className="w-100">
