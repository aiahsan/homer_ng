            ...
            <div className="col-xl-11 mx-auto col-12">
              <div className="row">
                ...
                <div className="col-lg-8 mt-3">
                  {Array.from({ length: 5 }, () => (
                    <div className="listing-inner mb-4" onClick={() => (location.href = "/detail")}>
                        ...
                        <div className="carousel-inner">
                          <div className="carousel-item active position-relative">
                            ...
                            <div className="listing-carousel-inner">
                              <div className="black-tag">Added on 20th Jan 2021</div>
                      ...
                      <div className="row mt-3">
                        <div className="col-lg-6">
                          <h3 className="bold mb-0">N 25, 000, 000</h3>
                          <p className="mt-3 mb-2 p-xs">
                            <i className="fas fa-map-marker-alt mr-2"></i> Ogombo Behind Abraham Adesanya
                          </p>
                          <p className="mt-3 p-lg bold">Semi Detached Bungalow</p>
                        ...
                        <div className="col-lg-6 text-right">
                          <p className="bold mb-0">Typical Mortgage Offers</p>
                          <div className="row mt-3">
                            <div className="col-4 border-right">
                              <p className="mb-0">Interest: 10%</p>
                            </div>
                            <div className="col-4 border-right">
                              <p className="mb-0">Equity: 10%</p>
                            </div>
                            <div className="col-4">
                              <p className="mb-0">Tenor: 5 years</p>
                            </div>
                          </div>
                          <a href="#_" className="site-btn rounded mt-4 px-5 py-2">
