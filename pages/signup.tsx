              ...
              <div className="col-xl-11 mx-auto">
                <div className="row">
                  <div className="col-lg-6 mt-3">
                    <p className="p-lg bold">We will need you to create an account to store your application details</p>
                    <p className="p-lg bold">Create Account</p>
                    <form action="#_">
                      <div className="position-relative">
                        ...
                        <input type="email" placeholder="Email" className="px-5 site-input py-3" />
                      </div>
                      <div className="position-relative mt-4">
                        ...
                        <input type="password" placeholder="Password" className="px-5 site-input py-3" />
                      ...
                      <div className="position-relative mt-4">
                        ...
                        <input type="password" placeholder="Confirm Password" className="px-5 site-input py-3" />
                        <div className="right-icon">
                          <svg
                            width="24"
                            height="24"
                      ...
                      <div className="mt-4">
                        ...
                        <label>
                          I agree to the <span className="l-blue-text bold"> Terms of Service</span> and{" "}
                          <span className="l-blue-text bold"> Privacy Policy</span>
                        </label>
                      </div>
                      <button className="mt-4 site-btn w-100 py-3">Create Account and Continue Application</button>
                      <p className="mt-4">
                        Already registered?{" "}
                  ...
                  <div className="col-lg-6 mt-3">
                    <p className="p-lg bold">Or Sign Up with</p>
                    <div className="row">
                      <div className="col-sm-6 mt-3">
                        <a href="#_">
                          <span className="social-link">
                            ...
                            <p className="bold p-lg mt-3">Google</p>
                          </span>
                        </a>
                      </div>
                      <div className="col-sm-6 mt-3">
                        <a href="#_">
                          <span className="social-link">
                            ...
                            <p className="bold p-lg mt-3">Facebook</p>
                          </span>
                        </a>
                      </div>
                    </div>
