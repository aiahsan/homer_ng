              ...
              <div className="col-xl-11 mx-auto">
                <div className="row">
                  <div className="col-lg-6 mt-3">
                    <img src="/images/login-left-1.png" alt="" className="img-fluid h-100 d-none d-lg-block w-100" />
                  </div>
                  <div className="col-lg-6 mt-3 listing-inner">
                    <p className="p-lg bold text-center">Login</p>
                    <form action="#_">
                    ...
                    <p className="p-lg bold text-center">Or</p>
                    <div className="row justify-content-center">
                      <div className="col-lg-4 col-sm-6 mt-3">
                        <a href="#_">
                          <span className="social-link h-auto py-4">
                            <svg
                              width="37"
                              height="37"
                              viewBox="0 0 37 37"
