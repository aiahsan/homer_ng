...
export default () => {
  ...
  return <>
    ...
    <Main>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className=" col-12">
                <div className="row">
                  <div className="col-12">
                    <h3 className="blue-text">Homer Homes</h3>
                  </div>
                              ...
                              {activeTab == 0 ? (
                                <div className="details px-3 py-4">
                                  ...
                                  <div className="text-center">
                                    <button onClick={()=>handleShow()} className="site-btn mt-3 px-3 py-2">Apply For Finance To Buy</button>
                                  </div>
                                </div>
                              ) : (
                                <>
      ...
      <ApplyModal show={show} handleClose={handleClose} />
    </Main>
  </>
}